...
去雅礼洋湖 1km 的路出租车司机不想接，要么就是坐地起价 20RMB。

到了先领了餐票和水卡，去试机赛。

系统是 Ubuntu 16.04，用起来还算习惯，配好了 vim。

OJ 网址是 oj.thusaac.org，试机账号 TWC_TEST-xxx，密码是 twctwc（没有创意差评）。
...
T3 是给出一个 1800*1800 的 RGB 图像，要求找出该图像的所有角点。
...
题目：给出 1-15 的奇数，选出 3 个，做任意正整数为指数的幂，或者任意正整数为底数的对数，再求和使得和为 30。

这不随便 log3(9)+13+15 就稳了吗。
